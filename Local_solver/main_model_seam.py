...
## 1. Create a model
## Run file create_model_seam_full.py
## Run file create_model_seam_local.py
...
## 12. Plot traces
plot_traces(shotgather_extra='output/shotgather_extrapolated.mat', geom=geom, shotgather_wf= 'output/shotgather_wf.mat', xp=20, time_i=650, time_f=900) 
